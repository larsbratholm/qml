...
Until the preprint is available from arXiv, please cite this GitHub repository as:
    ...
    AS Christensen, LA Bratholm, S Amabilino, FA Faber, B Huang, OA von Lilienfeld (2017) "QML: A Python Toolkit for Quantum Machine Learning" https://github.com/qmlcode/qml
