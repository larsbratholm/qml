...
estimator = wrappers.OAMNN(iterations=400, batch_size=70, scoring_function="mae", tensorboard=True, l2_reg=0.03906198710720926,
                        hidden_layer_sizes=[50, 20], learning_rate=0.005, representation="slatm", slatm_dgrid1 = 0.12)
...
filenames = glob.glob("/Volumes/Transcend/data_sets/OH_squalane_model/geoms/training/*.xyz")[:100]
filenames.sort()
...
energies = np.loadtxt('/Volumes/Transcend/data_sets/OH_squalane_model/geoms/training/properties_kjmol.txt', usecols=[1])[:100]
